...
# Appearance mode is injected into the existing static UI at request time.
# This avoids rewriting the multi-megabyte self-contained index.html and keeps
# the locked Update Monitor layout/geometry untouched.
_UPDATE_MONITOR_THEME_BOOTSTRAP = r'''<script id="um-theme-bootstrap-v0364">
(function(){
  try{
    const saved=localStorage.getItem('updateMonitorTheme');
...
_UPDATE_MONITOR_THEME_SETTING = r'''      <div class="setting appearance-setting">
        <label id="appearanceLabel" for="themeSelect">Appearance</label>
        <select id="themeSelect" class="settings-native-select">
          <option id="themeDark" value="dark">Dark mode</option>
          <option id="themeLight" value="light">Light mode</option>
        </select>
      </div>

'''

_UPDATE_MONITOR_THEME_STYLE = r'''<style id="um-theme-mode-v0364">
/* Appearance mode only: no dimensions, spacing or layout are changed. */
html[data-theme="light"]{
  color-scheme:light;
  --background:#eef3f7;
  --header:#f8fafc;
  --card:rgba(255,255,255,.94);
  --card-hover:rgba(246,249,252,.98);
  --border:rgba(79,102,124,.30);
  --text:#1d2a36;
  --muted:#66798b;
  --green:#218a55;
  --blue:#2f6fca;
  --yellow:#9b6b13;
  --red:#b53f3f;
  --ui-menu-line-color:rgba(79,102,124,.34);
}
html[data-theme="light"] body::before{
  background-color:#eef3f7 !important;
  opacity:.11;
  filter:grayscale(.55) brightness(1.45);
}
html[data-theme="light"] header,
html[data-theme="light"] .settings-panel,
html[data-theme="light"] .system-info-panel{
  background:#f8fafc !important;
  color:var(--text) !important;
  box-shadow:0 10px 28px rgba(35,52,68,.12);
}
html[data-theme="light"] .login-card,
html[data-theme="light"] .update-card,
html[data-theme="light"] .update-details,
html[data-theme="light"] .summary-dropdown,
html[data-theme="light"] .header-warning-popover,
html[data-theme="light"] .policy-modal-shell,
html[data-theme="light"] .docker-info-dialog,
html[data-theme="light"] .port-conflict-dialog,
html[data-theme="light"] .backup-restore-dialog,
html[data-theme="light"] .backup-preview-dialog,
html[data-theme="light"] .backup-settings-dialog,
html[data-theme="light"] .image-source-dialog,
html[data-theme="light"] .uninstall-panel,
html[data-theme="light"] .docker-info-container-card,
html[data-theme="light"] .docker-info-image-card,
html[data-theme="light"] .image-source-image-card,
html[data-theme="light"] .image-source-summary-card{
  background:#fff !important;
  color:var(--text) !important;
  border-color:var(--border) !important;
  box-shadow:0 8px 24px rgba(35,52,68,.10);
}
html[data-theme="light"] .update-card:hover{background:#fbfdff !important;}
html[data-theme="light"] .setting select,
html[data-theme="light"] .settings-custom-select-button,
html[data-theme="light"] .settings-custom-select-menu,
html[data-theme="light"] .github-token-input,
html[data-theme="light"] .backup-encryption-input,
html[data-theme="light"] .policy-time-picker-button,
html[data-theme="light"] .policy-backup-select-button,
html[data-theme="light"] .policy-backup-select-menu,
html[data-theme="light"] .backup-retention-select-button,
html[data-theme="light"] .backup-retention-select-wrap .policy-backup-select-menu{
  background:#f7fafc !important;
  color:#1d2a36 !important;
  border-color:rgba(79,102,124,.34) !important;
}
html[data-theme="light"] .settings-custom-select-option:hover,
html[data-theme="light"] .settings-custom-select-option.active,
html[data-theme="light"] .policy-backup-select-option:hover,
html[data-theme="light"] .policy-backup-select-option.active,
html[data-theme="light"] .backup-retention-select-option:hover,
html[data-theme="light"] .backup-retention-select-option.active{
  background:rgba(47,111,202,.10) !important;
  color:#174f9b !important;
}
html[data-theme="light"] .logout-button,
html[data-theme="light"] .github-token-button,
html[data-theme="light"] .icon-button,
html[data-theme="light"] .update-details-button,
html[data-theme="light"] .smart-full-check-button,
html[data-theme="light"] .policy-modal-action-button,
html[data-theme="light"] .backup-restore-button,
html[data-theme="light"] .image-source-entry-button,
html[data-theme="light"] .um-card-tool{
  background:#f5f8fb !important;
  color:#243746 !important;
  border-color:rgba(79,102,124,.34) !important;
}
html[data-theme="light"] .logout-button:hover,
html[data-theme="light"] .github-token-button:hover,
html[data-theme="light"] .icon-button:hover,
html[data-theme="light"] .update-details-button:hover,
html[data-theme="light"] .smart-full-check-button:hover,
html[data-theme="light"] .policy-modal-action-button:hover,
html[data-theme="light"] .backup-restore-button:hover,
html[data-theme="light"] .image-source-entry-button:hover,
html[data-theme="light"] .um-card-tool:hover{
  background:#eaf2f9 !important;
  border-color:rgba(47,111,202,.42) !important;
}
html[data-theme="light"] .settings-title,
html[data-theme="light"] .update-card-title,
html[data-theme="light"] .policy-modal-name,
html[data-theme="light"] .policy-modal-title-copy,
html[data-theme="light"] .update-backup-detail-title,
html[data-theme="light"] .header-warning-popover-title,
html[data-theme="light"] .uninstall-panel-title{color:#182633 !important;}
html[data-theme="light"] .setting label,
html[data-theme="light"] .setting-help,
html[data-theme="light"] .update-card-stat-label,
html[data-theme="light"] .update-details-label,
html[data-theme="light"] .system-info-label,
html[data-theme="light"] .policy-modal-subtitle{color:#657789 !important;}
html[data-theme="light"] .system-info-value,
html[data-theme="light"] .update-card-stat-value,
html[data-theme="light"] .update-details-value{color:#243746 !important;}
html[data-theme="light"] .backup-settings-retention,
html[data-theme="light"] .policy-modal-option,
html[data-theme="light"] .policy-modal-auto{
  background:rgba(47,111,202,.035) !important;
  border-color:rgba(79,102,124,.25) !important;
}
html[data-theme="light"] .brand-info-button{
  background:#f4f8fb !important;
  color:#243746 !important;
  border-color:rgba(79,102,124,.42) !important;
  box-shadow:0 3px 10px rgba(35,52,68,.12);
}
html[data-theme="light"] .brand-info-button:hover,
html[data-theme="light"] .brand-info-button.active{
  background:#e7f0f8 !important;
  border-color:rgba(47,111,202,.46) !important;
}
html[data-theme="light"] .settings-icon-2d{color:#33495a !important;}
html[data-theme="light"] input::placeholder{color:#8a9aa8 !important;}
html[data-theme="light"] #umPageScrollbarV21{background:rgba(55,76,94,.08) !important;}
html[data-theme="light"] #umPageScrollbarThumbV21{background:rgba(55,76,94,.38) !important;}
</style>
'''

_UPDATE_MONITOR_THEME_RUNTIME = r'''<script id="um-theme-runtime-v0364">
(function(){
  const copy={
    de:{label:'Darstellung',dark:'Dunkelmodus',light:'Hellmodus'},
    en:{label:'Appearance',dark:'Dark mode',light:'Light mode'},
    fr:{label:'Apparence',dark:'Mode sombre',light:'Mode clair'},
    pt:{label:'Aparência',dark:'Modo escuro',light:'Modo claro'},
    es:{label:'Apariencia',dark:'Modo oscuro',light:'Modo claro'}
  };
  function language(){
    try{return (typeof state!=='undefined'&&state.language)||localStorage.getItem('updateMonitorLanguage')||'en';}
    catch(e){return 'en';}
  }
  function syncText(){
    ...
    if(select&&typeof syncSettingsCustomSelect==='function')syncSettingsCustomSelect(select);
  }
  function apply(theme,persist){
    ...
    if(meta)meta.setAttribute('content',next==='light'?'#f8fafc':'#151e27');
    if(persist){try{localStorage.setItem('updateMonitorTheme',next);}catch(e){}}
    if(select&&typeof syncSettingsCustomSelect==='function')syncSettingsCustomSelect(select);
  }
  const select=document.getElementById('themeSelect');
  let saved='dark';
  try{saved=localStorage.getItem('updateMonitorTheme')==='light'?'light':'dark';}catch(e){}
  apply(saved,false);
  syncText();
  if(select)select.addEventListener('change',function(){apply(select.value,true);});
  const languageSelect=document.getElementById('languageSelect');
  if(languageSelect)languageSelect.addEventListener('change',function(){setTimeout(syncText,0);});
})();
</script>
'''

_INDEX_THEME_CACHE = {"mtime_ns": None, "html": None}
_INDEX_THEME_LOCK = threading.Lock()


def _index_html_with_appearance_mode():
    ...
    with _INDEX_THEME_LOCK:
        if _INDEX_THEME_CACHE["mtime_ns"] == mtime_ns and _INDEX_THEME_CACHE["html"] is not None:
            return _INDEX_THEME_CACHE["html"]

        try:
            html = index_path.read_text(encoding="utf-8")
        except OSError as exc:
            raise HTTPException(status_code=500, detail="Update Monitor UI could not be read") from exc

        if 'id="um-theme-bootstrap-v0364"' not in html:
            html = html.replace("<style>", _UPDATE_MONITOR_THEME_BOOTSTRAP + "<style>", 1)
        if 'id="um-theme-mode-v0364"' not in html:
            html = html.replace("</head>", _UPDATE_MONITOR_THEME_STYLE + "\n</head>", 1)
        if 'id="themeSelect"' not in html:
            anchor = '''      <div class="setting">
        <label id="timeFormatLabel" for="timeFormatSelect">Time format</label>'''
            if anchor in html:
                html = html.replace(anchor, _UPDATE_MONITOR_THEME_SETTING + anchor, 1)
        if 'id="um-theme-runtime-v0364"' not in html:
            html = html.replace("</body>", _UPDATE_MONITOR_THEME_RUNTIME + "\n</body>", 1)

        _INDEX_THEME_CACHE["mtime_ns"] = mtime_ns
        _INDEX_THEME_CACHE["html"] = html
        return html
...
def index():
    return HTMLResponse(
        _index_html_with_appearance_mode(),
        headers={
